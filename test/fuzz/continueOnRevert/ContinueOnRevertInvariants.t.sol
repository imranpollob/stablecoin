 ...
 * @notice Invariant tests with continue-on-revert behavior
 * @dev Tests protocol invariants that must hold during fuzz testing with continue-on-revert
 */
...
contract ContinueOnRevertInvariants is StdInvariant, Test {
    ...
    /// @dev forge-config: default.invariant.fail-on-revert = false
    ...
    /// @notice Invariant: Call summary function for tracking purposes
    /// @dev forge-config: default.invariant.fail-on-revert = false
